...
export default function App() {
  ...
  //This will the get token from localstorage and decode it when the page loads up and set it as our initial state
  ...
  return (
    <Routes>
      <Route path="/" element={<FeedPage handleSignUpOrLogin={handleSignUpOrLogin} user={user} />} />
      <Route path="/login" element={<LoginPage handleSignUpOrLogin={handleSignUpOrLogin} />} />
      <Route path="/signup" element={<SignUpPage handleSignUpOrLogin={handleSignUpOrLogin} />} />
